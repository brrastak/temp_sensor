...
struct WWDG
{
  ...
  struct CR : public RegisterBase<0x40002C00, 32, ReadWriteMode>
  {
    ...
    using FieldValues = WWDG_CR_WDGA_Values<WWDG::CR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CFR : public RegisterBase<0x40002C04, 32, ReadWriteMode>
  {
    ...
    using WDGTB = WWDG_CFR_WDGTB_Values<WWDG::CFR, 7, 2, ReadWriteMode, WWDGCFRBase> ;
    using EWI = WWDG_CFR_EWI_Values<WWDG::CFR, 9, 1, ReadWriteMode, WWDGCFRBase> ;
    using FieldValues = WWDG_CFR_EWI_Values<WWDG::CFR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using EWI = WWDG_SR_EWI_Values<WWDG::SR, 0, 1, ReadWriteMode, WWDGSRBase> ;
    using FieldValues = WWDG_SR_EWI_Values<WWDG::SR, 0, 0, NoAccess, NoAccess> ;
  } ;
