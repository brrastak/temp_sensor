...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct USART1_SR_NE_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<USART1_SR_NE_Values, BaseType, 0U> ;
  using Value1 = FieldValue<USART1_SR_NE_Values, BaseType, 1U> ;
} ;
