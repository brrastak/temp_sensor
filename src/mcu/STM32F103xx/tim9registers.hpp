...
struct TIM9
{
  ...
  struct CR1 : public RegisterBase<0x40014C00, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x40014C00, 32, ReadWriteMode, TIM9CR1Base, T...> ;

  struct TIM9CR2Base {} ;

  struct CR2 : public RegisterBase<0x40014C04, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR2Pack  = Register<0x40014C04, 32, ReadWriteMode, TIM9CR2Base, T...> ;

  struct TIM9SMCRBase {} ;

  struct SMCR : public RegisterBase<0x40014C08, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SMCRPack  = Register<0x40014C08, 32, ReadWriteMode, TIM9SMCRBase, T...> ;

  struct TIM9DIERBase {} ;

  struct DIER : public RegisterBase<0x40014C0C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DIERPack  = Register<0x40014C0C, 32, ReadWriteMode, TIM9DIERBase, T...> ;

  struct TIM9SRBase {} ;

  struct SR : public RegisterBase<0x40014C10, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SRPack  = Register<0x40014C10, 32, ReadWriteMode, TIM9SRBase, T...> ;

  struct TIM9EGRBase {} ;

  struct EGR : public RegisterBase<0x40014C14, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using EGRPack  = Register<0x40014C14, 32, WriteMode, TIM9EGRBase, T...> ;

  struct TIM9CCMR1_OutputBase {} ;

  struct CCMR1_Output : public RegisterBase<0x40014C18, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCMR1_OutputPack  = Register<0x40014C18, 32, ReadWriteMode, TIM9CCMR1_OutputBase, T...> ;

  struct TIM9CCMR1_InputBase {} ;

  struct CCMR1_Input : public RegisterBase<0x40014C18, 32, ReadWriteMode>
  {
    using IC2F = TIM9_CCMR1_Input_IC2F_Values<TIM9::CCMR1_Input, 12, 4, ReadWriteMode, TIM9CCMR1_InputBase> ;
    using IC2PSC = TIM9_CCMR1_Input_IC2PSC_Values<TIM9::CCMR1_Input, 10, 2, ReadWriteMode, TIM9CCMR1_InputBase> ;
    using CC2S = TIM9_CCMR1_Input_CC2S_Values<TIM9::CCMR1_Input, 8, 2, ReadWriteMode, TIM9CCMR1_InputBase> ;
    using IC1F = TIM9_CCMR1_Input_IC1F_Values<TIM9::CCMR1_Input, 4, 4, ReadWriteMode, TIM9CCMR1_InputBase> ;
    using IC1PSC = TIM9_CCMR1_Input_IC1PSC_Values<TIM9::CCMR1_Input, 2, 2, ReadWriteMode, TIM9CCMR1_InputBase> ;
  ...
  template<typename... T> 
  using CCMR1_InputPack  = Register<0x40014C18, 32, ReadWriteMode, TIM9CCMR1_InputBase, T...> ;

  struct TIM9CCERBase {} ;

  struct CCER : public RegisterBase<0x40014C20, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCERPack  = Register<0x40014C20, 32, ReadWriteMode, TIM9CCERBase, T...> ;

  struct TIM9CNTBase {} ;

  struct CNT : public RegisterBase<0x40014C24, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CNTPack  = Register<0x40014C24, 32, ReadWriteMode, TIM9CNTBase, T...> ;

  struct TIM9PSCBase {} ;

  struct PSC : public RegisterBase<0x40014C28, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PSCPack  = Register<0x40014C28, 32, ReadWriteMode, TIM9PSCBase, T...> ;

  struct TIM9ARRBase {} ;

  struct ARR : public RegisterBase<0x40014C2C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ARRPack  = Register<0x40014C2C, 32, ReadWriteMode, TIM9ARRBase, T...> ;

  struct TIM9CCR1Base {} ;

  struct CCR1 : public RegisterBase<0x40014C34, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR1Pack  = Register<0x40014C34, 32, ReadWriteMode, TIM9CCR1Base, T...> ;

  struct TIM9CCR2Base {} ;

  struct CCR2 : public RegisterBase<0x40014C38, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR2Pack  = Register<0x40014C38, 32, ReadWriteMode, TIM9CCR2Base, T...> ;
