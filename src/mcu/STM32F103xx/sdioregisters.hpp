...
struct SDIO
{
  ...
  struct POWER : public RegisterBase<0x40018000, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using POWERPack  = Register<0x40018000, 32, ReadWriteMode, SDIOPOWERBase, T...> ;

  struct SDIOCLKCRBase {} ;

  struct CLKCR : public RegisterBase<0x40018004, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SDIO_CLKCR_HWFC_EN_Values<SDIO::CLKCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CLKCRPack  = Register<0x40018004, 32, ReadWriteMode, SDIOCLKCRBase, T...> ;

  struct SDIOARGBase {} ;

  struct ARG : public RegisterBase<0x40018008, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ARGPack  = Register<0x40018008, 32, ReadWriteMode, SDIOARGBase, T...> ;

  struct SDIOCMDBase {} ;

  struct CMD : public RegisterBase<0x4001800C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SDIO_CMD_CE_ATACMD_Values<SDIO::CMD, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CMDPack  = Register<0x4001800C, 32, ReadWriteMode, SDIOCMDBase, T...> ;

  struct SDIORESPCMDBase {} ;

  struct RESPCMD : public RegisterBase<0x40018010, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RESPCMDPack  = Register<0x40018010, 32, ReadMode, SDIORESPCMDBase, T...> ;

  struct SDIORESPI1Base {} ;

  struct RESPI1 : public RegisterBase<0x40018014, 32, ReadMode>
  {
    using CARDSTATUS1 = SDIO_RESPI1_CARDSTATUS1_Values<SDIO::RESPI1, 0, 32, ReadMode, SDIORESPI1Base> ;
    using FieldValues = SDIO_RESPI1_CARDSTATUS1_Values<SDIO::RESPI1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RESPI1Pack  = Register<0x40018014, 32, ReadMode, SDIORESPI1Base, T...> ;

  struct SDIORESP2Base {} ;

  struct RESP2 : public RegisterBase<0x40018018, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RESP2Pack  = Register<0x40018018, 32, ReadMode, SDIORESP2Base, T...> ;

  struct SDIORESP3Base {} ;

  struct RESP3 : public RegisterBase<0x4001801C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RESP3Pack  = Register<0x4001801C, 32, ReadMode, SDIORESP3Base, T...> ;

  struct SDIORESP4Base {} ;

  struct RESP4 : public RegisterBase<0x40018020, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RESP4Pack  = Register<0x40018020, 32, ReadMode, SDIORESP4Base, T...> ;

  struct SDIODTIMERBase {} ;

  struct DTIMER : public RegisterBase<0x40018024, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DTIMERPack  = Register<0x40018024, 32, ReadWriteMode, SDIODTIMERBase, T...> ;

  struct SDIODLENBase {} ;

  struct DLEN : public RegisterBase<0x40018028, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DLENPack  = Register<0x40018028, 32, ReadWriteMode, SDIODLENBase, T...> ;

  struct SDIODCTRLBase {} ;

  struct DCTRL : public RegisterBase<0x4001802C, 32, ReadWriteMode>
  {
    ...
    using PWSTART = SDIO_DCTRL_PWSTART_Values<SDIO::DCTRL, 8, 1, ReadWriteMode, SDIODCTRLBase> ;
    using PWSTOP = SDIO_DCTRL_PWSTOP_Values<SDIO::DCTRL, 9, 1, ReadWriteMode, SDIODCTRLBase> ;
    ...
    using FieldValues = SDIO_DCTRL_SDIOEN_Values<SDIO::DCTRL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DCTRLPack  = Register<0x4001802C, 32, ReadWriteMode, SDIODCTRLBase, T...> ;

  struct SDIODCOUNTBase {} ;

  struct DCOUNT : public RegisterBase<0x40018030, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using DCOUNTPack  = Register<0x40018030, 32, ReadMode, SDIODCOUNTBase, T...> ;

  struct SDIOSTABase {} ;

  struct STA : public RegisterBase<0x40018034, 32, ReadMode>
  {
    ...
    using FieldValues = SDIO_STA_CEATAEND_Values<SDIO::STA, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using STAPack  = Register<0x40018034, 32, ReadMode, SDIOSTABase, T...> ;

  struct SDIOICRBase {} ;

  struct ICR : public RegisterBase<0x40018038, 32, ReadWriteMode>
  {
    ...
    using FieldValues = SDIO_ICR_CEATAENDC_Values<SDIO::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x40018038, 32, ReadWriteMode, SDIOICRBase, T...> ;

  struct SDIOMASKBase {} ;

  struct MASK : public RegisterBase<0x4001803C, 32, ReadWriteMode>
  {
    ...
    using DBACKENDIE = SDIO_MASK_DBACKENDIE_Values<SDIO::MASK, 10, 1, ReadWriteMode, SDIOMASKBase> ;
    ...
    using CEATENDIE = SDIO_MASK_CEATENDIE_Values<SDIO::MASK, 23, 1, ReadWriteMode, SDIOMASKBase> ;
    using FieldValues = SDIO_MASK_CEATENDIE_Values<SDIO::MASK, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using MASKPack  = Register<0x4001803C, 32, ReadWriteMode, SDIOMASKBase, T...> ;

  struct SDIOFIFOCNTBase {} ;

  struct FIFOCNT : public RegisterBase<0x40018048, 32, ReadMode>
  {
    using FIF0COUNT = SDIO_FIFOCNT_FIF0COUNT_Values<SDIO::FIFOCNT, 0, 24, ReadMode, SDIOFIFOCNTBase> ;
    using FieldValues = SDIO_FIFOCNT_FIF0COUNT_Values<SDIO::FIFOCNT, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using FIFOCNTPack  = Register<0x40018048, 32, ReadMode, SDIOFIFOCNTBase, T...> ;

  struct SDIOFIFOBase {} ;

  struct FIFO : public RegisterBase<0x40018080, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using FIFOPack  = Register<0x40018080, 32, ReadWriteMode, SDIOFIFOBase, T...> ;
