...
{
  using Value0 = FieldValue<TIM3_CCMR1_Input_IC2PSC_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM3_CCMR1_Input_IC2PSC_Values, BaseType, 1U> ;
  using Value2 = FieldValue<TIM3_CCMR1_Input_IC2PSC_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM3_CCMR1_Input_IC2PSC_Values, BaseType, 3U> ;
} ;
...
{
  using Value0 = FieldValue<TIM3_CCMR1_Input_IC1PSC_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM3_CCMR1_Input_IC1PSC_Values, BaseType, 1U> ;
  using Value2 = FieldValue<TIM3_CCMR1_Input_IC1PSC_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM3_CCMR1_Input_IC1PSC_Values, BaseType, 3U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM3_CCR3_CCR3_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
} ;
