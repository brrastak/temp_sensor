...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM14_CR2_MMS_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM14_CR2_MMS_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM14_CR2_MMS_Values, BaseType, 1U> ;
  using Value2 = FieldValue<TIM14_CR2_MMS_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM14_CR2_MMS_Values, BaseType, 3U> ;
  using Value4 = FieldValue<TIM14_CR2_MMS_Values, BaseType, 4U> ;
  using Value5 = FieldValue<TIM14_CR2_MMS_Values, BaseType, 5U> ;
  using Value6 = FieldValue<TIM14_CR2_MMS_Values, BaseType, 6U> ;
  using Value7 = FieldValue<TIM14_CR2_MMS_Values, BaseType, 7U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM14_CCMR1_Input_IC1PSC_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM14_CCMR1_Input_IC1PSC_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM14_CCMR1_Input_IC1PSC_Values, BaseType, 1U> ;
  using Value2 = FieldValue<TIM14_CCMR1_Input_IC1PSC_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM14_CCMR1_Input_IC1PSC_Values, BaseType, 3U> ;
} ;
