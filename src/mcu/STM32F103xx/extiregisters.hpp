...
*
* Details       : EXTI. This header file is auto-generated for STM32F103xx
*                 device.
*
*
*******************************************************************************/
...
struct EXTI
{
  ...
  struct IMR : public RegisterBase<0x40010400, 32, ReadWriteMode>
  {
    ...
    using FieldValues = EXTI_IMR_MR18_Values<EXTI::IMR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using IMRPack  = Register<0x40010400, 32, ReadWriteMode, EXTIIMRBase, T...> ;

  struct EXTIEMRBase {} ;

  struct EMR : public RegisterBase<0x40010404, 32, ReadWriteMode>
  {
    ...
    using FieldValues = EXTI_EMR_MR18_Values<EXTI::EMR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using EMRPack  = Register<0x40010404, 32, ReadWriteMode, EXTIEMRBase, T...> ;

  struct EXTIRTSRBase {} ;

  struct RTSR : public RegisterBase<0x40010408, 32, ReadWriteMode>
  {
    ...
    using FieldValues = EXTI_RTSR_TR18_Values<EXTI::RTSR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RTSRPack  = Register<0x40010408, 32, ReadWriteMode, EXTIRTSRBase, T...> ;

  struct EXTIFTSRBase {} ;

  struct FTSR : public RegisterBase<0x4001040C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = EXTI_FTSR_TR18_Values<EXTI::FTSR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using FTSRPack  = Register<0x4001040C, 32, ReadWriteMode, EXTIFTSRBase, T...> ;

  struct EXTISWIERBase {} ;

  struct SWIER : public RegisterBase<0x40010410, 32, ReadWriteMode>
  {
    ...
    using FieldValues = EXTI_SWIER_SWIER18_Values<EXTI::SWIER, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SWIERPack  = Register<0x40010410, 32, ReadWriteMode, EXTISWIERBase, T...> ;

  struct EXTIPRBase {} ;

  struct PR : public RegisterBase<0x40010414, 32, ReadWriteMode>
  {
    ...
    using FieldValues = EXTI_PR_PR18_Values<EXTI::PR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PRPack  = Register<0x40010414, 32, ReadWriteMode, EXTIPRBase, T...> ;
