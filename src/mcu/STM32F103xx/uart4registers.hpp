...
struct UART4
{
  ...
  struct SR : public RegisterBase<0x40004C00, 32, ReadWriteMode>
  {
    ...
    using NE = UART4_SR_NE_Values<UART4::SR, 2, 1, ReadMode, UART4SRBase> ;
    ...
    using FieldValues = UART4_SR_LBD_Values<UART4::SR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct BRR : public RegisterBase<0x40004C08, 32, ReadWriteMode>
  {
    ...
    using FieldValues = UART4_BRR_DIV_Mantissa_Values<UART4::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CR2 : public RegisterBase<0x40004C10, 32, ReadWriteMode>
  {
    ...
    using FieldValues = UART4_CR2_LINEN_Values<UART4::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CR3 : public RegisterBase<0x40004C14, 32, ReadWriteMode>
  {
    ...
    using FieldValues = UART4_CR3_DMAT_Values<UART4::CR3, 0, 0, NoAccess, NoAccess> ;
  } ;
