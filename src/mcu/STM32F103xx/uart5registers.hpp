...
struct UART5
{
  ...
  struct SR : public RegisterBase<0x40005000, 32, ReadWriteMode>
  {
    ...
    using NE = UART5_SR_NE_Values<UART5::SR, 2, 1, ReadMode, UART5SRBase> ;
    ...
    using FieldValues = UART5_SR_LBD_Values<UART5::SR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct BRR : public RegisterBase<0x40005008, 32, ReadWriteMode>
  {
    ...
    using FieldValues = UART5_BRR_DIV_Mantissa_Values<UART5::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CR2 : public RegisterBase<0x40005010, 32, ReadWriteMode>
  {
    ...
    using FieldValues = UART5_CR2_LINEN_Values<UART5::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CR3 : public RegisterBase<0x40005014, 32, ReadWriteMode>
  {
    ...
    using FieldValues = UART5_CR3_DMAT_Values<UART5::CR3, 0, 0, NoAccess, NoAccess> ;
  } ;
