...
struct TIM11
{
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x40015400, 32, ReadWriteMode, TIM11CR1Base, T...> ;

  struct TIM11CR2Base {} ;

  struct CR2 : public RegisterBase<0x40015404, 32, ReadWriteMode>
  {
    using MMS = TIM11_CR2_MMS_Values<TIM11::CR2, 4, 3, ReadWriteMode, TIM11CR2Base> ;
    using FieldValues = TIM11_CR2_MMS_Values<TIM11::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CR2Pack  = Register<0x40015404, 32, ReadWriteMode, TIM11CR2Base, T...> ;

  struct TIM11DIERBase {} ;

  struct DIER : public RegisterBase<0x4001540C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DIERPack  = Register<0x4001540C, 32, ReadWriteMode, TIM11DIERBase, T...> ;

  struct TIM11SRBase {} ;

  struct SR : public RegisterBase<0x40015410, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SRPack  = Register<0x40015410, 32, ReadWriteMode, TIM11SRBase, T...> ;

  struct TIM11EGRBase {} ;

  struct EGR : public RegisterBase<0x40015414, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using EGRPack  = Register<0x40015414, 32, WriteMode, TIM11EGRBase, T...> ;

  struct TIM11CCMR1_OutputBase {} ;

  struct CCMR1_Output : public RegisterBase<0x40015418, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCMR1_OutputPack  = Register<0x40015418, 32, ReadWriteMode, TIM11CCMR1_OutputBase, T...> ;

  struct TIM11CCMR1_InputBase {} ;

  struct CCMR1_Input : public RegisterBase<0x40015418, 32, ReadWriteMode>
  {
    using IC1F = TIM11_CCMR1_Input_IC1F_Values<TIM11::CCMR1_Input, 4, 4, ReadWriteMode, TIM11CCMR1_InputBase> ;
    using IC1PSC = TIM11_CCMR1_Input_IC1PSC_Values<TIM11::CCMR1_Input, 2, 2, ReadWriteMode, TIM11CCMR1_InputBase> ;
  ...
  template<typename... T> 
  using CCMR1_InputPack  = Register<0x40015418, 32, ReadWriteMode, TIM11CCMR1_InputBase, T...> ;

  struct TIM11CCERBase {} ;

  struct CCER : public RegisterBase<0x40015420, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCERPack  = Register<0x40015420, 32, ReadWriteMode, TIM11CCERBase, T...> ;

  struct TIM11CNTBase {} ;

  struct CNT : public RegisterBase<0x40015424, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CNTPack  = Register<0x40015424, 32, ReadWriteMode, TIM11CNTBase, T...> ;

  struct TIM11PSCBase {} ;

  struct PSC : public RegisterBase<0x40015428, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PSCPack  = Register<0x40015428, 32, ReadWriteMode, TIM11PSCBase, T...> ;

  struct TIM11ARRBase {} ;

  struct ARR : public RegisterBase<0x4001542C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ARRPack  = Register<0x4001542C, 32, ReadWriteMode, TIM11ARRBase, T...> ;

  struct TIM11CCR1Base {} ;

  struct CCR1 : public RegisterBase<0x40015434, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR1Pack  = Register<0x40015434, 32, ReadWriteMode, TIM11CCR1Base, T...> ;
