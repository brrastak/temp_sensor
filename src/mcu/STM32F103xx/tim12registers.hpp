...
struct TIM12
{
  ...
  struct CCMR1_Input : public RegisterBase<0x40001818, 32, ReadWriteMode>
  {
    ...
    using IC2PSC = TIM12_CCMR1_Input_IC2PSC_Values<TIM12::CCMR1_Input, 10, 2, ReadWriteMode, TIM12CCMR1_InputBase> ;
    ...
    using IC1PSC = TIM12_CCMR1_Input_IC1PSC_Values<TIM12::CCMR1_Input, 2, 2, ReadWriteMode, TIM12CCMR1_InputBase> ;
