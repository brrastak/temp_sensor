...
*
* Details       : FLASH. This header file is auto-generated for STM32F103xx
*                 device.
*
*
*******************************************************************************/
...
struct FLASH
{
  ...
  struct ACR : public RegisterBase<0x40022000, 32, ReadWriteMode>
  {
    ...
    using HLFCYA = FLASH_ACR_HLFCYA_Values<FLASH::ACR, 3, 1, ReadWriteMode, FLASHACRBase> ;
  ...
  struct SR : public RegisterBase<0x4002200C, 32, ReadWriteMode>
  {
    ...
    using WRPRTERR = FLASH_SR_WRPRTERR_Values<FLASH::SR, 4, 1, ReadWriteMode, FLASHSRBase> ;
  ...
  struct CR : public RegisterBase<0x40022010, 32, ReadWriteMode>
  {
    ...
    using FieldValues = FLASH_CR_EOPIE_Values<FLASH::CR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct OBR : public RegisterBase<0x4002201C, 32, ReadMode>
  {
    ...
    using RDPRT = FLASH_OBR_RDPRT_Values<FLASH::OBR, 1, 1, ReadMode, FLASHOBRBase> ;
    using WDG_SW = FLASH_OBR_WDG_SW_Values<FLASH::OBR, 2, 1, ReadMode, FLASHOBRBase> ;
    using nRST_STOP = FLASH_OBR_nRST_STOP_Values<FLASH::OBR, 3, 1, ReadMode, FLASHOBRBase> ;
    using nRST_STDBY = FLASH_OBR_nRST_STDBY_Values<FLASH::OBR, 4, 1, ReadMode, FLASHOBRBase> ;
    using Data0 = FLASH_OBR_Data0_Values<FLASH::OBR, 10, 8, ReadMode, FLASHOBRBase> ;
    using Data1 = FLASH_OBR_Data1_Values<FLASH::OBR, 18, 8, ReadMode, FLASHOBRBase> ;
