...
{
  using NoStopGeneration = FieldValue<I2C2_CR1_STOP_Values, BaseType, 0U> ;
  using StopGeneration = FieldValue<I2C2_CR1_STOP_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct I2C2_CR1_START_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using NoStartGeneration = FieldValue<I2C2_CR1_START_Values, BaseType, 0U> ;
  using StartGeneration = FieldValue<I2C2_CR1_START_Values, BaseType, 1U> ;
} ;
...
{
  using DisablePeripheral = FieldValue<I2C2_CR1_PE_Values, BaseType, 0U> ;
  using EnablePeripheral = FieldValue<I2C2_CR1_PE_Values, BaseType, 1U> ;
} ;
...
{
  using DisableBufferInterrupt = FieldValue<I2C2_CR2_ITBUFEN_Values, BaseType, 0U> ;
  using EnableBufferInterrupt = FieldValue<I2C2_CR2_ITBUFEN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct I2C2_CR2_ITEVTEN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using DisableEventInterrupt = FieldValue<I2C2_CR2_ITEVTEN_Values, BaseType, 0U> ;
  using EnableEventInterrupt = FieldValue<I2C2_CR2_ITEVTEN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct I2C2_CR2_ITERREN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using DisableErrorInterrupt = FieldValue<I2C2_CR2_ITERREN_Values, BaseType, 0U> ;
  using EnableErrorInterrupt = FieldValue<I2C2_CR2_ITERREN_Values, BaseType, 1U> ;
} ;
...
{
  using DataRegisterNotEmpty = FieldValue<I2C2_SR1_TxE_Values, BaseType, 0U> ;
  using DataRegisterEmpty = FieldValue<I2C2_SR1_TxE_Values, BaseType, 1U> ;
} ;
...
{
  using DataByteTransferNotDone = FieldValue<I2C2_SR1_BTF_Values, BaseType, 0U> ;
  using DataByteTransferSucceeded = FieldValue<I2C2_SR1_BTF_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct I2C2_SR1_ADDR_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using AddressNotSentReceived = FieldValue<I2C2_SR1_ADDR_Values, BaseType, 0U> ;
  using AddressSentReceived = FieldValue<I2C2_SR1_ADDR_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct I2C2_SR1_SB_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using NoStartCondition = FieldValue<I2C2_SR1_SB_Values, BaseType, 0U> ;
  using StartConditionGenerated = FieldValue<I2C2_SR1_SB_Values, BaseType, 1U> ;
} ;
...
{
  using NoCommunication = FieldValue<I2C2_SR2_BUSY_Values, BaseType, 0U> ;
  using CommunicationOngoing = FieldValue<I2C2_SR2_BUSY_Values, BaseType, 1U> ;
} ;
