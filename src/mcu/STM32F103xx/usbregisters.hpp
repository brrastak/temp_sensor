...
*                 file is auto-generated for STM32F103xx device.
*
*
*******************************************************************************/
...
struct USB
{
  ...
  {
    using EP_ID = USB_ISTR_EP_ID_Values<USB::ISTR, 0, 4, ReadWriteMode, USBISTRBase> ;
    using DIR = USB_ISTR_DIR_Values<USB::ISTR, 4, 1, ReadWriteMode, USBISTRBase> ;
    ...
    using CTR = USB_ISTR_CTR_Values<USB::ISTR, 15, 1, ReadWriteMode, USBISTRBase> ;
