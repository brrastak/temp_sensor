...
struct TIM13
{
  ...
  struct CR2 : public RegisterBase<0x40001C04, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM13_CR2_MMS_Values<TIM13::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CCMR1_Input : public RegisterBase<0x40001C18, 32, ReadWriteMode>
  {
    ...
    using IC1PSC = TIM13_CCMR1_Input_IC1PSC_Values<TIM13::CCMR1_Input, 2, 2, ReadWriteMode, TIM13CCMR1_InputBase> ;
