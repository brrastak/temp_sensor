...
struct TIM14
{
  ...
  struct CR2 : public RegisterBase<0x40002004, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM14_CR2_MMS_Values<TIM14::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CCMR1_Input : public RegisterBase<0x40002018, 32, ReadWriteMode>
  {
    ...
    using IC1PSC = TIM14_CCMR1_Input_IC1PSC_Values<TIM14::CCMR1_Input, 2, 2, ReadWriteMode, TIM14CCMR1_InputBase> ;
