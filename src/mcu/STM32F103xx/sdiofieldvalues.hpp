...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct SDIO_RESPI1_CARDSTATUS1_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct SDIO_DCTRL_PWSTART_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<SDIO_DCTRL_PWSTART_Values, BaseType, 0U> ;
  using Value1 = FieldValue<SDIO_DCTRL_PWSTART_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct SDIO_DCTRL_PWSTOP_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<SDIO_DCTRL_PWSTOP_Values, BaseType, 0U> ;
  using Value1 = FieldValue<SDIO_DCTRL_PWSTOP_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct SDIO_MASK_DBACKENDIE_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<SDIO_MASK_DBACKENDIE_Values, BaseType, 0U> ;
  using Value1 = FieldValue<SDIO_MASK_DBACKENDIE_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct SDIO_MASK_CEATENDIE_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<SDIO_MASK_CEATENDIE_Values, BaseType, 0U> ;
  using Value1 = FieldValue<SDIO_MASK_CEATENDIE_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct SDIO_FIFOCNT_FIF0COUNT_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
} ;
