...
struct TIM10
{
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x40015000, 32, ReadWriteMode, TIM10CR1Base, T...> ;

  struct TIM10CR2Base {} ;

  struct CR2 : public RegisterBase<0x40015004, 32, ReadWriteMode>
  {
    using MMS = TIM10_CR2_MMS_Values<TIM10::CR2, 4, 3, ReadWriteMode, TIM10CR2Base> ;
    using FieldValues = TIM10_CR2_MMS_Values<TIM10::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CR2Pack  = Register<0x40015004, 32, ReadWriteMode, TIM10CR2Base, T...> ;
  ...
  template<typename... T> 
  using DIERPack  = Register<0x4001500C, 32, ReadWriteMode, TIM10DIERBase, T...> ;
  ...
  template<typename... T> 
  using SRPack  = Register<0x40015010, 32, ReadWriteMode, TIM10SRBase, T...> ;
  ...
  template<typename... T> 
  using EGRPack  = Register<0x40015014, 32, WriteMode, TIM10EGRBase, T...> ;
  ...
  template<typename... T> 
  using CCMR1_OutputPack  = Register<0x40015018, 32, ReadWriteMode, TIM10CCMR1_OutputBase, T...> ;
  ...
  struct CCMR1_Input : public RegisterBase<0x40015018, 32, ReadWriteMode>
  {
    ...
    using IC1PSC = TIM10_CCMR1_Input_IC1PSC_Values<TIM10::CCMR1_Input, 2, 2, ReadWriteMode, TIM10CCMR1_InputBase> ;
  ...
  template<typename... T> 
  using CCMR1_InputPack  = Register<0x40015018, 32, ReadWriteMode, TIM10CCMR1_InputBase, T...> ;
  ...
  template<typename... T> 
  using CCERPack  = Register<0x40015020, 32, ReadWriteMode, TIM10CCERBase, T...> ;
  ...
  template<typename... T> 
  using CNTPack  = Register<0x40015024, 32, ReadWriteMode, TIM10CNTBase, T...> ;
  ...
  template<typename... T> 
  using PSCPack  = Register<0x40015028, 32, ReadWriteMode, TIM10PSCBase, T...> ;
  ...
  template<typename... T> 
  using ARRPack  = Register<0x4001502C, 32, ReadWriteMode, TIM10ARRBase, T...> ;
  ...
  template<typename... T> 
  using CCR1Pack  = Register<0x40015034, 32, ReadWriteMode, TIM10CCR1Base, T...> ;
