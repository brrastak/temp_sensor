...
struct ADC1
{
  ...
  struct SR : public RegisterBase<0x40012400, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SRPack  = Register<0x40012400, 32, ReadWriteMode, ADC1SRBase, T...> ;

  struct ADC1CR1Base {} ;

  struct CR1 : public RegisterBase<0x40012404, 32, ReadWriteMode>
  {
    ...
    using DUALMOD = ADC1_CR1_DUALMOD_Values<ADC1::CR1, 16, 4, ReadWriteMode, ADC1CR1Base> ;
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x40012404, 32, ReadWriteMode, ADC1CR1Base, T...> ;

  struct ADC1CR2Base {} ;

  struct CR2 : public RegisterBase<0x40012408, 32, ReadWriteMode>
  {
    using TSVREFE = ADC1_CR2_TSVREFE_Values<ADC1::CR2, 23, 1, ReadWriteMode, ADC1CR2Base> ;
    using SWSTART = ADC1_CR2_SWSTART_Values<ADC1::CR2, 22, 1, ReadWriteMode, ADC1CR2Base> ;
    using JSWSTART = ADC1_CR2_JSWSTART_Values<ADC1::CR2, 21, 1, ReadWriteMode, ADC1CR2Base> ;
    using EXTTRIG = ADC1_CR2_EXTTRIG_Values<ADC1::CR2, 20, 1, ReadWriteMode, ADC1CR2Base> ;
    using EXTSEL = ADC1_CR2_EXTSEL_Values<ADC1::CR2, 17, 3, ReadWriteMode, ADC1CR2Base> ;
    using JEXTTRIG = ADC1_CR2_JEXTTRIG_Values<ADC1::CR2, 15, 1, ReadWriteMode, ADC1CR2Base> ;
    using JEXTSEL = ADC1_CR2_JEXTSEL_Values<ADC1::CR2, 12, 3, ReadWriteMode, ADC1CR2Base> ;
    ...
    using RSTCAL = ADC1_CR2_RSTCAL_Values<ADC1::CR2, 3, 1, ReadWriteMode, ADC1CR2Base> ;
    using CAL = ADC1_CR2_CAL_Values<ADC1::CR2, 2, 1, ReadWriteMode, ADC1CR2Base> ;
  ...
  template<typename... T> 
  using CR2Pack  = Register<0x40012408, 32, ReadWriteMode, ADC1CR2Base, T...> ;

  struct ADC1SMPR1Base {} ;

  struct SMPR1 : public RegisterBase<0x4001240C, 32, ReadWriteMode>
  {
    using SMP10 = ADC1_SMPR1_SMP10_Values<ADC1::SMPR1, 0, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using SMP11 = ADC1_SMPR1_SMP11_Values<ADC1::SMPR1, 3, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using SMP12 = ADC1_SMPR1_SMP12_Values<ADC1::SMPR1, 6, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using SMP13 = ADC1_SMPR1_SMP13_Values<ADC1::SMPR1, 9, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using SMP14 = ADC1_SMPR1_SMP14_Values<ADC1::SMPR1, 12, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using SMP15 = ADC1_SMPR1_SMP15_Values<ADC1::SMPR1, 15, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using SMP16 = ADC1_SMPR1_SMP16_Values<ADC1::SMPR1, 18, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using SMP17 = ADC1_SMPR1_SMP17_Values<ADC1::SMPR1, 21, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using FieldValues = ADC1_SMPR1_SMP17_Values<ADC1::SMPR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SMPR1Pack  = Register<0x4001240C, 32, ReadWriteMode, ADC1SMPR1Base, T...> ;

  struct ADC1SMPR2Base {} ;

  struct SMPR2 : public RegisterBase<0x40012410, 32, ReadWriteMode>
  {
    using SMP0 = ADC1_SMPR2_SMP0_Values<ADC1::SMPR2, 0, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP1 = ADC1_SMPR2_SMP1_Values<ADC1::SMPR2, 3, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP2 = ADC1_SMPR2_SMP2_Values<ADC1::SMPR2, 6, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP3 = ADC1_SMPR2_SMP3_Values<ADC1::SMPR2, 9, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP4 = ADC1_SMPR2_SMP4_Values<ADC1::SMPR2, 12, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP5 = ADC1_SMPR2_SMP5_Values<ADC1::SMPR2, 15, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP6 = ADC1_SMPR2_SMP6_Values<ADC1::SMPR2, 18, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP7 = ADC1_SMPR2_SMP7_Values<ADC1::SMPR2, 21, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP8 = ADC1_SMPR2_SMP8_Values<ADC1::SMPR2, 24, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using SMP9 = ADC1_SMPR2_SMP9_Values<ADC1::SMPR2, 27, 3, ReadWriteMode, ADC1SMPR2Base> ;
    using FieldValues = ADC1_SMPR2_SMP9_Values<ADC1::SMPR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SMPR2Pack  = Register<0x40012410, 32, ReadWriteMode, ADC1SMPR2Base, T...> ;

  struct ADC1JOFR1Base {} ;

  struct JOFR1 : public RegisterBase<0x40012414, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using JOFR1Pack  = Register<0x40012414, 32, ReadWriteMode, ADC1JOFR1Base, T...> ;

  struct ADC1JOFR2Base {} ;

  struct JOFR2 : public RegisterBase<0x40012418, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using JOFR2Pack  = Register<0x40012418, 32, ReadWriteMode, ADC1JOFR2Base, T...> ;

  struct ADC1JOFR3Base {} ;

  struct JOFR3 : public RegisterBase<0x4001241C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using JOFR3Pack  = Register<0x4001241C, 32, ReadWriteMode, ADC1JOFR3Base, T...> ;

  struct ADC1JOFR4Base {} ;

  struct JOFR4 : public RegisterBase<0x40012420, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using JOFR4Pack  = Register<0x40012420, 32, ReadWriteMode, ADC1JOFR4Base, T...> ;

  struct ADC1HTRBase {} ;

  struct HTR : public RegisterBase<0x40012424, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using HTRPack  = Register<0x40012424, 32, ReadWriteMode, ADC1HTRBase, T...> ;

  struct ADC1LTRBase {} ;

  struct LTR : public RegisterBase<0x40012428, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LTRPack  = Register<0x40012428, 32, ReadWriteMode, ADC1LTRBase, T...> ;

  struct ADC1SQR1Base {} ;

  struct SQR1 : public RegisterBase<0x4001242C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR1Pack  = Register<0x4001242C, 32, ReadWriteMode, ADC1SQR1Base, T...> ;

  struct ADC1SQR2Base {} ;

  struct SQR2 : public RegisterBase<0x40012430, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR2Pack  = Register<0x40012430, 32, ReadWriteMode, ADC1SQR2Base, T...> ;

  struct ADC1SQR3Base {} ;

  struct SQR3 : public RegisterBase<0x40012434, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR3Pack  = Register<0x40012434, 32, ReadWriteMode, ADC1SQR3Base, T...> ;

  struct ADC1JSQRBase {} ;

  struct JSQR : public RegisterBase<0x40012438, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using JSQRPack  = Register<0x40012438, 32, ReadWriteMode, ADC1JSQRBase, T...> ;

  struct ADC1JDR1Base {} ;

  struct JDR1 : public RegisterBase<0x4001243C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR1Pack  = Register<0x4001243C, 32, ReadMode, ADC1JDR1Base, T...> ;

  struct ADC1JDR2Base {} ;

  struct JDR2 : public RegisterBase<0x40012440, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR2Pack  = Register<0x40012440, 32, ReadMode, ADC1JDR2Base, T...> ;

  struct ADC1JDR3Base {} ;

  struct JDR3 : public RegisterBase<0x40012444, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR3Pack  = Register<0x40012444, 32, ReadMode, ADC1JDR3Base, T...> ;

  struct ADC1JDR4Base {} ;

  struct JDR4 : public RegisterBase<0x40012448, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR4Pack  = Register<0x40012448, 32, ReadMode, ADC1JDR4Base, T...> ;

  struct ADC1DRBase {} ;

  struct DR : public RegisterBase<0x4001244C, 32, ReadMode>
  {
    using DATA = ADC1_DR_DATA_Values<ADC1::DR, 0, 16, ReadMode, ADC1DRBase> ;
    using ADC2DATA = ADC1_DR_ADC2DATA_Values<ADC1::DR, 16, 16, ReadMode, ADC1DRBase> ;
    using FieldValues = ADC1_DR_ADC2DATA_Values<ADC1::DR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DRPack  = Register<0x4001244C, 32, ReadMode, ADC1DRBase, T...> ;
