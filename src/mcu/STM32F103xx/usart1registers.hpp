...
*                 header file is auto-generated for STM32F103xx device.
*
*
*******************************************************************************/
...
struct USART1
{
  ...
  struct SR : public RegisterBase<0x40013800, 32, ReadWriteMode>
  {
    ...
    using NE = USART1_SR_NE_Values<USART1::SR, 2, 1, ReadMode, USART1SRBase> ;
  ...
  template<typename... T> 
  using SRPack  = Register<0x40013800, 32, ReadWriteMode, USART1SRBase, T...> ;

  struct USART1DRBase {} ;

  struct DR : public RegisterBase<0x40013804, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x40013804, 32, ReadWriteMode, USART1DRBase, T...> ;

  struct USART1BRRBase {} ;

  struct BRR : public RegisterBase<0x40013808, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using BRRPack  = Register<0x40013808, 32, ReadWriteMode, USART1BRRBase, T...> ;

  struct USART1CR1Base {} ;

  struct CR1 : public RegisterBase<0x4001380C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x4001380C, 32, ReadWriteMode, USART1CR1Base, T...> ;

  struct USART1CR2Base {} ;

  struct CR2 : public RegisterBase<0x40013810, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR2Pack  = Register<0x40013810, 32, ReadWriteMode, USART1CR2Base, T...> ;

  struct USART1CR3Base {} ;

  struct CR3 : public RegisterBase<0x40013814, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR3Pack  = Register<0x40013814, 32, ReadWriteMode, USART1CR3Base, T...> ;

  struct USART1GTPRBase {} ;

  struct GTPR : public RegisterBase<0x40013818, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using GTPRPack  = Register<0x40013818, 32, ReadWriteMode, USART1GTPRBase, T...> ;
